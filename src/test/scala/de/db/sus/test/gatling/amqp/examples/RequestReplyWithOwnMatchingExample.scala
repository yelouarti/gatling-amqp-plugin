package de.db.sus.test.gatling.amqp.examples

import io.gatling.core.Predef._
import io.gatling.core.structure.ScenarioBuilder
import de.db.sus.test.gatling.amqp.Predef._
import de.db.sus.test.gatling.amqp.examples.Utils.idFeeder
import de.db.sus.test.gatling.amqp.protocol.AmqpProtocolBuilder
